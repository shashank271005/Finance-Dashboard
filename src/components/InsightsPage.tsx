...
const cashflowData = [
  ...
  { name: 'Mar', income: 18000, expense: -11000 },
  { name: 'Apr', income: 14000, expense: -12000 },
  { name: 'May', income: 19000, expense: -13000 },
  { name: 'Jun', income: 16000, expense: -10000 },
  { name: 'Jul', income: 20230, expense: -9260 },
  { name: 'Aug', income: 17000, expense: -11000 },
  { name: 'Sep', income: 21000, expense: -14000 },
  { name: 'Oct', income: 18000, expense: -12000 },
  { name: 'Nov', income: 23000, expense: -15000 },
...
const SpendingBubbleChart: React.FC = () => {
    return (
      <div className="bubble-chart-container">
        <svg viewBox="0 0 500 300" className="bubble-svg">
          {/* Main Overlapping Circles */}
          <circle cx="350" cy="150" r="100" fill="url(#blueGrad)" className="bubble-main" />
          <circle cx="230" cy="130" r="70" fill="url(#pinkGrad)" className="bubble-pink" />
          <circle cx="150" cy="180" r="50" fill="url(#orangeGrad)" className="bubble-orange" />
          <circle cx="100" cy="220" r="30" fill="url(#yellowGrad)" className="bubble-yellow" />
          
          {/* Labels */}
          <text x="350" y="150" textAnchor="middle" className="bubble-label-main">RENT & LIVING</text>
          <text x="230" y="130" textAnchor="middle" className="bubble-label">INVESTMENT</text>
          <text x="150" y="180" textAnchor="middle" className="bubble-label-small">FOOD</text>
          <text x="100" y="245" textAnchor="middle" className="bubble-label-tiny">MOVIES</text>
          ...
          <text x="380" y="260" textAnchor="middle" className="bubble-label-tiny">HEALTHCARE</text>
    ...
    <div className="insights-view app-fade-in">
      ...
      <section className="insights-left">
        ...
        <div className="quick-actions">
          <button className="action-pill"><PlusIcon /> Top Up</button>
          <button className="action-pill active-pill"><TransferIcon /> Transfer</button>
          ...
          <div className="spending-insights-body">
            <div className="score-panel">
               ...
               <p className="score-desc">
                 Your spending habits are balanced but you can improve the overall spending by managing your rental and investment spending.
               </p>
            </div>
            <SpendingBubbleChart />
          </div>
        ...
        <div className="insight-card glassy-card cashflow-section">
          ...
          <div className="cashflow-summary">
            ...
            <div className="cashflow-legend">
                ...
                <div className="legend-item"><span className="dot dot-expense"></span> Expense</div>
            </div>
          </div>
          <div className="chart-container">
            <ResponsiveContainer width="100%" height={260}>
              <BarChart data={cashflowData} margin={{ top: 20, right: 0, left: 0, bottom: 0 }} barGap={0}>
                ...
                />
                <Bar dataKey="income" fill="#3B4CF0" radius={[4, 4, 0, 0]} barSize={12} />
                <Bar dataKey="expense" fill="#4F70F5" radius={[0, 0, 4, 4]} barSize={12} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
